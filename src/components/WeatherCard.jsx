...
const WeatherCard = ({ weather, loading }) => {
  if (loading) {
    return (
      <div className="bg-linear-to-r/longer from-indigo-500 to-teal-400 rounded-2xl p-8 text-white shadow-2xl animate-pulse-subtle">
        ...
        <div className="h-12 bg-white/20 rounded w-20 mb-4"></div>
  ...
  if (!weather) {
    return (
      <div className="bg-gradient-to-br from-gray-400 to-gray-600 rounded-2xl p-8 text-white shadow-2xl">
  ...
  return (
    <div className="bg-linear-to-r/longer from-indigo-500 to-teal-400 rounded-2xl p-8 text-white shadow-2xl animate-fade-in">
      <div className="flex items-center justify-between mb-6">
        <div>
      ...
      <div className="mb-6">
        ...
        <p className="text-xl text-blue-100 capitalize">{weather.description}</p>
        <p className="text-sm text-blue-200">Feels like {weather.feelsLike}°C</p>
      </div>
